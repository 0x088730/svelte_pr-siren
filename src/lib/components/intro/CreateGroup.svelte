...
<h2 class="font-semibold text-dark-text text-menu mb-sm">step 3</h2>

<h1 class="font-medium text-intro-title mb-md">Create new group</h1>
...
>
	<h2 class="flex font-medium">
		...
		<span
			>Open left side menu in Telegram App and click Create new telegram group,
			after write name</span
		>
	</h2>

	<img
		src="/intro/create-group{$theme == 'light' ? '-light' : ''}.svg"
		alt=""
	...
	<h2 class="mt-10 font-medium">
		...
		Open bot and put <span class="font-semibold text-primary">/start</span>
	</h2>

	<img
		src="/intro/start{$theme == 'light' ? '-light' : ''}.svg"
		alt=""
		class="w-full mt-4 mb-2"
	/>
	...
	<h2 class="flex mt-10 mb-4 font-medium">
		<span class="inline-block mr-2 font-semibold text-primary">05</span>
